...
for k,v in type.items():
    for mon in mons:
        for day in days:
            cur_date=mon+day
            output=open("F:/workspace/git/Graph-MP/data/mesonet_data/"+k+"/"+cur_date+".txt","a+")
            data=[]
            if dateIdx.has_key(cur_date):
                ...
                dayIdx+=1
            with open("F:/workspace/git/Graph-MP/data/output.txt","r") as oF:
                ...
                for line in oF.readlines():
                    ...
                    fileName="F:/workspace/git/Graph-MP/data/data_request/"+line.strip()
